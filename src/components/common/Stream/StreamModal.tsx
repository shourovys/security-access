...
import { cancelIcon, channelIcon } from '../../../utils/icons'
...
const StreamModal: React.FC<IProps> = ({ type, name, deviceId, setOpenModal }) => {
  ...
  // API URL for fetching stream data based on the component's 'type' prop
  const streamReqUrl =
    type === 'camera' ? cameraApi.getStream(deviceId || '0') : channelApi.getStream(deviceId || '0')
  ...
  // Header action buttons for switching between 'main' and 'sub' streaming
    ...
    <div className="w-full p-4 bg-white rounded-md">
      <FormContainer twoPart={false}>
        <FormCardWithHeader
          ...
          padding={false}
        >
          {/* LiveBox component to show the live stream */}
          <LiveBox
