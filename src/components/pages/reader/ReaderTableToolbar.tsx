...
import { IReaderFilters } from '../../../types/pages/reader'
...
interface IProps {
  filterState: IReaderFilters
  handleFilterApply: () => void
  handleFilterStateReset: () => void
  handleInputChange: THandleFilterInputChange
}

function ReaderTableToolbar({
  filterState,
  handleFilterApply,
  ...
  return (
    <TableToolbarContainer>
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-x-3 sm:gap-y-2 lg:gap-x-5">
        <Input
          name="ReaderNo"
          placeholder={t`Reader No`}
          value={filterState.ReaderNo}
        ...
        <Input
          name="ReaderName"
          placeholder={t`Reader Name`}
          value={filterState.ReaderName}
          onChange={handleInputChange}
        />
      </div>
...
export default ReaderTableToolbar
