...
import { IScheduleFilters } from '../../../types/pages/schedule'
  ...
  return (
    <TableToolbarContainer>
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-x-3 sm:gap-y-2 lg:gap-x-5">
        <Input
          name="ScheduleNo"
          placeholder={t`Schedule No`}
          value={filterState.ScheduleNo}
        ...
        <Input
          ...
          value={filterState.ScheduleName}
          onChange={handleInputChange}
        />
      </div>
