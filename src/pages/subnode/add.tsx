...
import validateSubNodeFormData from '../../utils/validation/subNode'
import SubnodeForm from '../../components/pages/subnode/form/SubnodeForm'
import serverErrorHandler from '../../utils/serverErrorHandler'
import t from '../../utils/translator'

// Component to create a Subnode
function CreateSubnode() {
  ...
  const [formData, setFormData] = useState<ISubnodeFormData>({
    ...
    Device: '/dev/ttyS2',
    Baudrate: '9600',
    DeviceType: subnodeDeviceTypeOptions[0],
    PortCount: '',
  })
  const [formErrors, setFormErrors] = useStateWithCallback<IFormErrors>({}, scrollToErrorElement)

  // Set default Node
  useDefaultNodeOption<ISubnodeFormData>(setFormData)
  ...
  const { trigger, isMutating } = useSWRMutation(subnodeApi.add, sendPostRequest, {
    onSuccess: () => {
      addSuccessfulToast()
      // redirect to subnode list page on success
      navigate(routeProperty.subnode.path())
    },
  ...
  const handleSubmit = async () => {
    ...
    const errors = validateSubNodeFormData(formData)
  ...
  return (
    <Page>
      ...
      {/* <FormActionButtonsContainer>
        ...
        <Button size="large" color="cancel" link={routeProperty.subnode.path()}>
