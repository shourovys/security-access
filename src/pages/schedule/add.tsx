...
// Component to create a Schedule
function CreateSchedule() {
  ...
  useDefaultPartitionOption<IScheduleFormData>(setFormData)
  ...
  const { trigger, isMutating } = useSWRMutation(scheduleApi.add, sendPostRequest, {
    onSuccess: () => {
      addSuccessfulToast()
      // redirect to schedule list page on success
      navigate(routeProperty.schedule.path())
    },
