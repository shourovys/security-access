...
import {
  IAccessReportApiQueryParams,
  IAccessReportFilters,
  IAccessReportStoreQueryParams,
...
import AccessReportPrintModal from '../../components/pages/accessreport/AccessReportPrintModal'
...
function AccessReport() {
  ...
  const apiQueryParamsWithoutPagination: IAccessReportStoreQueryParams = {
    sort_by: orderBy,
    order,
  ...
  const { trigger: saveDataTrigger, isMutating: csvDataLoading } = useSWRMutation(
    accessReportApi.save(apiQueryStringWithOutPagination),
    fetcher,
    {
      onSuccess: (saveData) => {
