...
import { useDefaultDefinedFieldNo } from '../../hooks/useDefaultOption'
...
// Component to create a DefinedField
function CreateDefinedField() {
  ...
  const [formErrors, setFormErrors] = useStateWithCallback<INewFormErrors<IDefinedFieldFormData>>(
    {},
    scrollToErrorElement
  )
  //
  useDefaultDefinedFieldNo<IDefinedFieldFormData>(setFormData)
  ...
  const { trigger, isMutating } = useSWRMutation(definedFieldApi.add, sendPostRequest, {
    onSuccess: () => {
      addSuccessfulToast()
      // redirect to definedField list page on success
      navigate(routeProperty.definedField.path())
    },
  ...
  return (
    <Page>
      ...
      {/* <FormActionButtonsContainer>
        ...
        <Button size="large" color="cancel" link={routeProperty.definedField.path()}>
...
export default CreateDefinedField
