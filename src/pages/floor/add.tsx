...
function CreateFloor() {
  ...
  useDefaultPartitionOption<IFloorFormData>(setFormData)
  ...
  const { trigger, isMutating } = useSWRMutation(floorApi.add, sendPostRequest, {
    onSuccess: () => {
      addSuccessfulToast()
      // redirect to floor list page on success
      navigate(routeProperty.floor.path())
    },
  ...
  return (
    <Page>
      ...
      {/* <FormActionButtonsContainer>
        ...
        <Button size="large" color="cancel" link={routeProperty.floor.path()}>
