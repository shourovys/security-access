...
// Component to create a Partition
function CreatePartition() {
  ...
  const [formErrors, setFormErrors] = useStateWithCallback<INewFormErrors<IPartitionFormData>>(
    {},
  ...
  const { trigger, isMutating } = useSWRMutation(partitionApi.add, sendPostRequest, {
    onSuccess: () => {
      addSuccessfulToast()
      // redirect to partition list page on success
      navigate(routeProperty.partition.path())
    },
  ...
  return (
    <Page>
      ...
      {/* <FormActionButtonsContainer>
        ...
        <Button size="large" color="cancel" link={routeProperty.partition.path()}>
