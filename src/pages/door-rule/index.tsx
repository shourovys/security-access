...
function DoorRule() {
  ...
  const {
    ...
    handleSelectRow,
    handleSelectAllRow,
  } = useTable({ defaultOrderBy: 'RuleNo' })
  ...
  const TABLE_HEAD: ITableHead[] = [
    ...
    ...(showPartition ? [{ id: 'Partition', label: t`Partition`, filter: true }] : []),
  ...
  //Change add position and add delete icon(modify breadcrumbsActions position alsoand added delete  button disablity when not selected any row).--rubel
