...
import { useDefaultNvrOption, useDefaultPartitionOption } from '../../hooks/useDefaultOption'
...
function CreateChannel() {
  ...
  // Set default Partition and Nvr
  useDefaultPartitionOption<IChannelFormData>(setFormData)
  useDefaultNvrOption<IChannelFormData>(setFormData)
  ...
  const { trigger, isMutating } = useSWRMutation(channelApi.add, sendPostRequest, {
    onSuccess: () => {
      addSuccessfulToast()
      // redirect to channel list page on success
      navigate(routeProperty.channel.path())
    },
  ...
  return (
    <Page>
      ...
      {/* <FormActionButtonsContainer>
        ...
        <Button size="large" color="cancel" link={routeProperty.channel.path()}>
